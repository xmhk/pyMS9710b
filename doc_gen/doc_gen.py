...
list_get_functions = [
    ['method', 'description','input type', 'input range','output type','output range'],
...
list_set_functions = [['method', 'description','input type', 'input range','output type','output range'],
                      ...
                      ['Spectrometer.set_current_memory(val)','sets current memory bank','STRING','A, B','',''],
                      ['Spectrometer.set_current_trace(val)','sets current trace','STRING','A, B','',''],
